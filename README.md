...
Sezione ampia, con una struttura chiaramente pensata per il ripasso progressivo:

- appunti divisi per capitoli
...
Il valore di questa cartella sta nel mix tra teoria e pratica, con esempi direttamente eseguibili accanto a PDF di studio.

### Sistemi Operativi

Materiale misto tra teoria e codice, con particolare attenzione a concetti di sincronizzazione e programmazione di sistema.

Sono presenti, tra gli altri:

- una mind map del corso
- file C di laboratorio
- una sottocartella dedicata a teoria e implementazione

### Telecomunicazioni

Raccolta focalizzata in particolare sulle reti, con materiali su:

- protocolli e throughput
...
Cartella essenziale ma chiara, con materiali su:
...
La repository include inoltre cartelle dedicate a:
